...
{
    public async Task<bool> ValidateAsync(string localAuthority, string fileUri, List<string> errors)
    {
        ...
        return errors.Count == 0 && await dataValidator.ValidateAsync(data, localAuthority, workflows, errors);
    }
}
